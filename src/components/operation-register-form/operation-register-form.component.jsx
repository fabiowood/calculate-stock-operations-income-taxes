...
const OperationRegisterForm = ({ updateAveragePriceAndQuantity, calculateStockOperationResults }) => {
  ...
  const { operationType, operationDate, stockTitle, operationPrice, operationQuantity, brokerage, displayResultsToClient } = operationData;
  ...
  return (
    <Fragment>
      ...
      {
        displayResultsToClient && <p>Cadastro realizado com sucesso!</p>
      }
    </Fragment>
  )
};
